<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteInscripcion.aspx.cs" Inherits="CapaPresentacion.MasterEstudiante.ReporteInscripcion" %>
...
<body>
    ...
    <script src="jsEst/ReporteInscripcion.js?v=<%= DateTime.Now.ToString("yyyyMMddHHmmss") %>" type="text/javascript"></script>
    <%--<script src="jsEst/ReporteInscripcion.js" type="text/javascript"></script>--%>
</body>
</html>
