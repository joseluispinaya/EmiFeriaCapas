                ...
                <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                    ...
                    <div class="text-start mb-3">
                        <div class="mb-3">
                            ...
                            <input type="email" id="txtCorreo" name="Correo" class="form-control" placeholder="Ingrese su correo" value="marbinach@yopmail.com">
                        </div>

                        <div class="mb-3">
                            <label class="form-label" for="txtClave">Contraseña</label>
                            <input type="password" id="txtClave" class="form-control" placeholder="Ingrese su contraseña" value="31323334">
                        </div>
