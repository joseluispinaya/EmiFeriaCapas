                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="txtCorreo" name="Correo" class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-1">
                                        <label for="txtNroci" class="form-label">Nro C.I.</label>
                                        <input type="text" id="txtNroci" name="NroCI" class="form-control form-control-sm">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-1">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="number" id="txtCelular" name="Celular" class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-1">
                                        <label for="txtCodigo" class="form-label">Codigo</label>
                                        <input type="text" id="txtCodigo" name="Codigo" class="form-control form-control-sm">
                                    </div>
                                </div>
                            </div>
