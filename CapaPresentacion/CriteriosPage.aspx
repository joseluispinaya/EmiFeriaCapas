<%@ Page Title="" Language="C#" MasterPageFile="~/PageHome.Master" AutoEventWireup="true" CodeBehind="CriteriosPage.aspx.cs" Inherits="CapaPresentacion.CriteriosPage" %>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="d-flex card-header justify-content-between align-items-center">
                    <h4 class="header-title">Criterios de Calificacion</h4>
                    <button type="button" id="btnNuevore" class="btn btn-info btn-sm">Agregar <i class="ti ti-plus ms-1"></i></button>
                </div>

                <div class="card-body">
                    <table class="table table-striped table-sm" id="tbCriterios" cellspacing="0" style="width: 100%">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Criterios</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modalLabeldetalle">Criterios</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-1">
                        <label for="txtNombre" class="form-label">Nuevo Criterio</label>
                        <input type="text" id="txtNombre" name="Nombre" class="form-control form-control-sm">
                    </div>
                    <div class="row">
                        <div class="col-md-8">
                            <div class="mb-1">
                                <label for="cboAspecto" class="form-label">Selec Aspecto</label>
                        ...
                        <div class="col-md-12">
                            <table class="table table-striped table-sm" id="tbDetallesCa" cellspacing="0" style="width: 100%">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Indicadores de Evaluacion</th>
                                        <th>Puntaje</th>
                                    </tr>
                                </thead>
                                <tbody>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="js/CriteriosPage.js?v=<%= DateTime.Now.ToString("yyyyMMddHHmmss") %>" type="text/javascript"></script>
</asp:Content>
